...
import { useAuth } from '../../../../firebase/AuthContext'; // تأكد من المسار الصحيح

const PointsPage = ({ userCourses = [], setUserCourses = () => {} }) => {
  ...
  const confirmRedeem = async () => {
    ...
    try {
      ...
      await updateDoc(userDocRef, {
        points: increment(-selectedCourse.pointsRequired),
      ...
      // تحديث دورات المستخدم في Firestore
      await updateDoc(userDocRef, {
        courses: updatedCourses
      });

      // تحديث الحالة المحلية
      setUserPoints(prev => prev - selectedCourse.pointsRequired);
      ...
      console.error("Error redeeming course:", err);
      setError("Failed to redeem course. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
